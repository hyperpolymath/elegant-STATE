...
:experimental:
:url-github: https://github.com/hyperpolymath/elegant-STATE
:url-gitlab: https://gitlab.com/hyperpolymath/elegant-STATE
:url-bitbucket: https://bitbucket.org/hyperpolymath/elegant-STATE
:url-codeberg: https://codeberg.org/hyperpolymath/elegant-STATE

Elegant state machine definition and visualization
...
elegant-STATE is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
